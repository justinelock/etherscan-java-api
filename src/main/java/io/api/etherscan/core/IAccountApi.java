...
public interface IAccountApi {
    ...
    @NotNull
    List<TxToken> getTxsToken(String address, String sort) throws ApiException;

    @NotNull
    List<TxToken> getTxsToken(String address, int page, int offset, String sort) throws ApiException;

    @NotNull
    List<TxToken> getTxsToken(String address, long startBlock, int page, int offset, String sort) throws ApiException;

    @NotNull
    List<TxToken> getTxsToken(String address, long startBlock, long endBlock, int page, int offset, String sort) throws ApiException;
